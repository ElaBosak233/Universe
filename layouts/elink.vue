        ...
        <main class="p-6 sm:p-10 space-y-6">
            ...
            >
                <div class="flex flex-col md:col-span-2 md:row-span-2 bg-white shadow rounded-lg">
                    ...
                    >The number of applied and left students per month</div>
                    ...
                    <div class="overflow-y-auto" style="max-height: 24rem;">
                        <ul class="p-6 space-y-6">
                            <li class="flex items-center">
                                <div
                                    class="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden"
                                >
                                    <img
                ...
                <div class="flex flex-col row-span-3 bg-white shadow rounded-lg">
                    <div
                        class="px-6 py-5 font-semibold border-b border-gray-100"
                    >Students by type of studying</div>
                    <div class="p-4 flex-grow">
                        <div
